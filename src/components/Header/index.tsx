...
function Header () {
    ...
    function startDropDown () {
        document.getElementById('dropdown')?.classList.toggle('show-dropdown-content')
    }
    ...
    return (
        ...
        <div className='container'>
            ...
            <img
                ...
                alt="prime video" 
            />
            <p className='text-menu-color' onClick={startDropDown} id='explore-drop'>
                Explorar
            </p>
            ...
            <div className='display-2'>
                <BiSearch color='#8197a4' size={25} className='search-icon'/>
        ...
        <div className='dropdown-content' id='dropdown'>
                ...
                <Link to="/channel">Canais</Link>
                <Link to="/category">Categorias</Link>
                <Link to="/my-space">Minha área</Link>
            </div>
        </>
